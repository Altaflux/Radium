...
public class ClassVisitor extends EnkelBaseVisitor<ClassDeclaration> {
    ...
    public ClassVisitor(List<EnkelParser.ImportDeclarationContext> importDeclarationContexts) {
    ...
    public ClassDeclaration visitClassDeclaration(@NotNull ClassDeclarationContext ctx) {
        ...
        ImportResolver importResolver = new ImportResolver(importDeclarationContexts);
        scope = new Scope(metaData, importResolver);
